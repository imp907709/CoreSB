...
namespace InfrastructureCheckers
{
    ...
    {
        public static string MsSQlCoreSBConnection =>
            "Server=192.168.0.100,1433;Database=coreSB;User Id=sa;password=QwErTy_1;MultipleActiveResultSets=true";

        public static string DockerMsSQlCoreSBConnection =>
            "Server=WINDOWS-VCTMMRG\\SQLEXPRESS;Database=coreSB;Trusted_Connection=True;";

        public static string PgSQlCoreSBConnection =>
            "Host=localhost;Port=5433;Database=coreSB;Username=postgres;Password=postgres";
    }
    ...
    public static class RepoAndUOWCheck
    {
        ...
        public static void DbWithRepoReinitCheck()
        {
            ...
            using (ContextNewOrder newOrderContext = new ContextNewOrder(new DbContextOptionsBuilder<ContextNewOrder>()
                .UseSqlServer(connectionStringSQLnewOrder).Options))
            {
...
namespace NetPlatformCheckers
{
    ...
    public static class Operators
    {
        public class NumenatorDenumenator
        {
            ...
            public static NumenatorDenumenator operator -(NumenatorDenumenator operandB) =>
                new NumenatorDenumenator(-operandB._numenator, operandB._denumenator);
    ...
    public static class StringObjectEquality
    {
        public static void GO()
        {
            ...
            var isTrue = (st0 == st2) && (st2 == st3) && (st0 == ob0) && (st0 == st1) && (st1 == obr) && (obr == ob0) &&
                         (ob0 == ob1)
                         && (ob1 == dr) && (dr == d0) && (d0 == d1);
    ...
    public class RecordsStructsReadonlyCheck
    {
        public static void GO()
        {
            ...
            */
            ...
            RecordWithClass rwc = new()
            {
                A = "A",
                items = new List<ItemForRecord>() {new() {Id = 1, Name = "name1"}, new() {Id = 2, Name = "name2"}}
            };
    ...
    public class EngineBrokeEventArgs : EventArgs
    {
    ...
    */
    ...
    public class PrintOrCancell : EventArgs
    {
    ...
    public class CountAsync
    {
        ...
        void logToConsole()
        {
            ...
            Console.Write("\r Solving: {0}, {1}", DateTime.Now.ToString("dd.MM.yyyy hh:mm:ss"),
                progress[st].ToString());
            if (st < progress.Length - 1) { st += 1; }
            else { st = 0; }
        }
    ...
    public class AsyncCheck
    {
        ...
        public async Task<string> SumResultOfCollectionOfTasks()
        {
            ...
            {
                DoSomeDelayedrWork(1000), DoSomeDelayedrWork(1000), DoSomeDelayedrWork(500)
            };
    ...
    public class ModelForReflectionTwo
    {
        public Guid Id { get; set; }
        public string Name { get; set; }
        [New(AttrType = true)] public string Sername { get; set; }
    }
    ...
    */
    ...
    public class LinqCheck
    {
        ...
        static void NewOverallCasesCheck()
        {
            ...
            {
                new Item1() {Id = 0, Name = "item1", Amount = 2, properties = new List<Property1>() {props1[0]}},
                new Item1()
                {
                    Id = 1,
                    Name = "item2",
                    Amount = 1,
                    properties = new List<Property1>() {new Property1() {Id = 0, Name = "prop1"}}
                },
                new Item1()
                {
                    Id = 2,
                    Name = "item3",
                    Amount = 3,
                    properties = new List<Property1>() {props1[0], props1[1], props1[2]}
                },
                new Item1()
                {
                    Id = 3,
                ...
                new Item1()
                {
                    Id = 5,
                    Name = "item6",
                    properties = new List<Property1>() {new Property1() {Id = 5, Name = "prop11"}}
                }
            };
            var items2 = new List<Item2>()
            {
                new Item2()
                {
                    ...
                    Name = "item1",
                    Amount = 0,
                    properties = new List<Property1>() {props1[0]},
                ...
                new Item2()
                {
                    ...
                    Name = "item3",
                    Amount = 1,
                    properties = new List<Property1>() {props1[2], new Property1() {Id = 2, Name = "prop5"}}
                }
            };
            ...
            var propsToSearch = new List<Property1>() {props1[0], new Property1() {Id = 1, Name = "prop3"}, props1[2]};
            var propsToSearch2 = new List<Property1>() {new Property1() {Id = 1, Name = "prop8"}, props1[2]};
            ...
            var l0 = new List<dynamic>
            {
                new
                {
                    name = "name1",
                    id = 1,
                    prop = new List<dynamic> {new {id = 1, title = "title1"}, new {id = 2, title = "title2"}}
                },
                new {name = "name2", id = 2},
                new {name = "name3", id = 3}
            };
            ...
            // 0 1 2 3 4 
            var whereExistsAny = items1.Where(s => propsToSearch.Exists(c => s.properties.Any(x => x.Name == c.Name)))
                .ToList();
            ...
            var groupBy = (
                ...
                group new {s3} by new {name1 = s1.Name}
                into g
                select new {name = g.Key.name1, count = g.Count(s => !string.IsNullOrEmpty(s?.s3?.Name))}
            ).ToList();

            var selectMany = items1
                .SelectMany(i => i.properties, (l, r) => new {item = l.Name, name = r.Name, amtl = l.Amount})
                .ToList();
            var selectManySelect = items1
                .SelectMany(i => i.properties, (l, r) => new {item = l, property = r, amtr = l.Amount})
                .Select(s => new {item = s.item.Name, name = s.property.Name}).ToList();

            var selectManyItems2 = items2.SelectMany(i => i.properties,
                (l, r) => new {item = l.Name, name = r.Name, amtr = l.Amount});
            ...
            (
                ...
                // || or
                group new {s3} by new {iteml = s1.item, propl = s1.name, itemr = s3?.item, propr = s3?.item}
                into g
                select new
                {
                    iteml = g.Key.iteml,
            ...
            (
                ...
                group new {s2} by new {iteml = s1.item, propl = s1.name, itemr = s2?.Name}
                into g
                select new
                {
                    iteml = g.Key.iteml,
            ...
            var selectManyOne = items1
                .SelectMany(p => p.properties, (l, r) => new {name = l.Name, amt = l.Amount, prop = r.Name})
                .ToList();
            var selectManyTwo = items2
                .SelectMany(p => p.properties, (l, r) => new {name = l.Name, amt = l.Amount, prop = r.Name})
                .ToList();
            ...
            var groupJoin = selectManyOne.GroupJoin(selectManyTwo,
                    k => k.amt,
                    r => r.amt,
                    (l, r) => new {name = l.name, l.prop, l.amt, ramt = r.Sum(s => s.amt + l.amt)})
                .ToList();

            var groupBy_ = selectManyOne.GroupBy(
                    lk => new {lk.name, lk.prop},
                    rk => rk.amt,
                    (l, r) => new {l.name, l.prop, amt = r.Sum(s => s)})
                .ToList();
        }
        ...
        static void OldRacersCheck()
        {
            ...
            (
                ...
                from s3 in jn.DefaultIfEmpty()
                group new {s3} by new {name = s1.Name}
                into g
                select new {name = g.Key, adv = g.Count(o => !string.IsNullOrEmpty(o?.s3?.Evnt))}
            ).ToList();
            ...
            var gp = adventures.Join(events,
                ...
                .GroupBy(q => q.Name)
                .Select(s => new {Name = s.Key, Count = s.Count(o => !string.IsNullOrEmpty(o?.Evt))})
                .ToList();
            ...
            List<PetOwners> petownersWithPets = new List<PetOwners>()
            {
                new PetOwners
                {
                    OwnerName = @"Owner1",
                    OwnerInt = 0,
                    PetsStr = new List<string>() {@"Pet1", @"Pet2"},
                    Pets = new List<PetForOwner>()
                    {
                        new PetForOwner() {Name = @"Pet1"}, new PetForOwner() {Name = @"Pet2"}
                    }
                },
                new PetOwners
                {
                    OwnerName = @"Owner2",
                    OwnerInt = 1,
                    PetsStr = new List<string>() {@"Pet3", @"Pet4", @"Pet5"},
                    Pets = new List<PetForOwner>()
                    {
                        new PetForOwner() {Name = @"Pet3"},
                        new PetForOwner() {Name = @"Pet4"},
                        new PetForOwner() {Name = @"Pet5"}
                    }
                },
                new PetOwners
                {
                ...
                new PetOwners
                {
                    OwnerName = @"Owner4",
                    OwnerInt = 3,
                    PetsStr = new List<string>() {@"Pet7", @"Pet8", @"Pet9", @"Pet10"},
                    Pets = new List<PetForOwner>()
                    {
                        new PetForOwner() {Name = @"Pet7"},
                        new PetForOwner() {Name = @"Pet8"},
                        new PetForOwner() {Name = @"Pet9"},
                        new PetForOwner() {Name = @"Pet10"}
                    }
                }
            };
            ...
            var ownersOfPets =
                ...
                select new {Owner = s?.OwnerName ?? "", Pet = c?.Name ?? ""};

            var owersOfPetsAPI =
                petownersWithPets.Join(petsWithOwners, petowner => petowner, pet => pet.Owner,
                    (petowner, pet) => new {Owner = petowner.OwnerName, Pet = pet.Name});
            ...
            //Join 
            var joinRacerCups =
                racers.Join(cups, r => r.Name, c => c.RacerName, (r, c) => new {racer = r.Name, cup = c.Competition});

            IEnumerable<string> racerNameIntersect =
                (from s in cups select s.RacerName).Intersect(from r in racers select r.Name);
            IEnumerable<string> racerNameExcept =
                (from r in racers select r.Name).Except(from s in cups select s.RacerName);
            ...
            var cupsByYearQuery =
                ...
                into g
                select new {Year = g.Key.Year, Cnt = g.Count()};

            var cupsByYearAPI = cups.GroupBy(p => p.Year, (z, x) => new {Year = z, Cnt = x.Count()});

            //group by several columns
            var f =
                from t in cups
                group t by new {t.Competition, t.Year}
                into t2
            ...
            var RacersCountByCar =
                from s in racers
                group s by new {s.Car}
                into g
                select new {Car = g.Key.Car, RacersCountAll = g.Count()};

            var RacersCountByCarAndYear =
                from s in racers
                group s by new {s.Year, s.Car}
                into g
                ...
                petownersWithPets.Aggregate<PetOwners, PetOwners, PetOwners>(new PetOwners(),
                    (seed, next) =>
                        (seed?.PetsStr?.Any() != true)
                            ? next
                            : next.PetsStr.Count() > seed?.PetsStr?.Count()
                                ? next
                                : seed,
                    po => po);
            ...
            var j =
                (from t in h
                    ...
                    select new {t.Name, t.Car, t2.Competition, t2.Position}).Skip(2 * 2).Take(2).ToList();
            ;
            ...
            var k =
                ...
                select new
                {
                    t2.Competition, t2.Position, Name = t == null ? @"" : t.Name, Car = t == null ? @"" : t.Car
                };
            ...
            var l =
                ...
                select new {Name = t.Car, Count = cnt};

            var m =
                from t in racers
                group t by t.Car
                into r
                select new {Car = r.Key, Racers = (from t2 in r select t2.Name).Count()};
        ...
        public static void bulkCheck()
        {
            ...
            var u = users.Where(s =>
                    s?.Address != null && s.Address.Count() > 1 && s.Address.Any(c => c.name == "Name_1"))
                .ToList();
        ...
        public static void MaxDateCheck()
        {
            ...
            var Name = maxDateByName.Where(s => s.Key != null && s.LastDate != null).OrderByDescending(c => c.LastDate)
                .FirstOrDefault()?.Key;
        }
        ...
        {
            List<Item> items2 = new List<Item>() {new Item {Id = 0, Name = "nm0"}, new Item {Id = 1, Name = "nm1"}};
        ...
        public static void SequenceCheck()
        {
            ...
            List<Item> checkList = new List<Item>() {i0, i1, i2};

            List<Item> listNotEqual = new List<Item>() {i0, i2};

            List<Item> listEqual = new List<Item>() {i0, i1, i2};
        ...
        public static void WhereAnyContains()
        {
            ...
            List<Item> servicesIds =
                new List<Item>() {new Item() {Id = 1, Name = "Nm1"}, new Item() {Id = 2, Name = "Nm2"}};
        ...
        public static void DeferredCheck()
        {
            ...
            List<Item> items = new List<Item>()
            {
                new Item() {Id = 0, Name = "nm1"},
                new Item() {Id = 1, Name = "nm2"},
                new Item() {Id = 2, Name = "nm3"},
                new Item() {Id = 1, Name = "nm4"}
            };
            int id = 2;
        ...
        public static void LinqSumGroupByNew()
        {
            ...
            var prices = new[] {new Price {InstrumentID = 5, Value = 2}, new Price {InstrumentID = 6, Value = 10}};
            ...
            var q0 = from t1 in (from s in prices select s)
                ...
                select new {Id = t2.instrument.Underlying.ID, Price = t2.Quantity * t1.Value};
            q0 = q0.ToList();

            var qt =
                from s2 in (from s in (from z in new List<Instrument>() {under1, under2} select z).ToList()
                    select new {ID = s.ID})
                join c2 in (from c in positions
                    select new
                    {
                        ID = c.instrument.Underlying.ID, Qnt = c.Quantity, Name = c.instrument.Underlying.Name
                    }) on s2.ID equals c2.ID
                group c2 by new {c2.Name, c2.ID}
                into g
                select new {Name = g.Key.Name, ID = g.Key.ID, Amt = g.Sum(t => t.Qnt)};

            var pr =
                (from s2 in (from s in (from z in new List<Instrument>() {instr1, instr2, instr3} select z).ToList()
                        select new {ID = s.Underlying.ID})
            ...
            var qt2 = from q in (
                        ...
                        join c2 in (from c in positions
                            select new
                            {
                                ID = c.instrument.Underlying.ID,
                                Qnt = c.Quantity,
                                Name = c.instrument.Underlying.Name
                            }) on s2.ID equals c2.ID
                        group c2 by new {c2.Name, c2.ID}
                        into g
                        select new {Name = g.Key.Name, ID = g.Key.ID, Amt = g.Sum(t => t.Qnt)}
                    ...
                    join p in
                        (from s2 in (from s in (from z in new List<Instrument>() {instr1, instr2, instr3} select z)
                                    .ToList()
                                select new {ID = s.Underlying.ID})
                            join c2 in (from c in prices select new {ID = c.InstrumentID, Val = c.Value}) on s2.ID
                                equals c2.ID
                            select new {s2.ID, c2.Val}).GroupBy(x => x.ID).Select(s => s.First())
                        on q.ID equals p.ID
...
namespace Algorithms
{
        ...
        public AlgorithmTest(List<TestListsStructs<T>> testArr, SortingDelegate m)
        {
            ...
            foreach (var item in testArr)
            {
                this.TestLists.Add(new TestListsStructs<T>()
                    {
                        Arrange = item?.Arrange?.Select(c => c).ToList(),
                        Expected = item?.Expected?.Select(c => c).ToList()
                    }
                );
            }
    ...
    public class Check
    {
        ...
        IList<T> copyTo<T>(IList<T> from, int st = 0, int fn = -1)
        {
        ...
        List<TestListsStructs<int>> createManualIntCollection()
        {
            return new List<TestListsStructs<int>>()
            {
                ...
                new TestListsStructs<int>()
                {
                    Arrange = new List<int>() {3, 1, 2}, Expected = new List<int> {1, 2, 3}
                },
                new TestListsStructs<int>()
                {
                    Arrange = new List<int>()
        ...
        void sampleIntCheck()
        {
            ...
            var toHeapSort = copyTo(initialArray);
            var sorted = HeapSort.Sort(toHeapSort);
            var b3 = sorted.SequenceEqual(sortedArr);

            BinarySearch bs = new BinarySearch();
            var idx = bs.SearchSorted(sortedArr, 7);
            bool b4 = idx == 6;

            InterpolationSearch ipls = new InterpolationSearch();
            var idx2 = ipls.Search(sortedArr, 7);
            var b5 = idx2 == 6;
        }
    }
    ...
    public class HeapSort
    {
        ...
        {
            var _arr = new int[arr.Count];
            Array.Copy(arr.ToArray(), _arr, arr.Count);
            result = _arr.ToList();
        ...
        void heapify(IList<int> arr, int st, int max)
        {
            var lg = st;
            int leftIdx = st * 2 + 1;
            int rightIdx = st * 2 + 2;

            if (leftIdx < max && arr[leftIdx] > arr[lg])
                lg = leftIdx;

            if (rightIdx < max && arr[rightIdx] > arr[lg])
                lg = rightIdx;
        ...
        void swap(IList<int> arr, int l, int r)
        {
    ...
    public class MergeSortTest
    {
        ...
        void MergeSortIntTest()
        {
            List<TestListsStructs<int>> arr = new List<TestListsStructs<int>>()
            {
                ...
                new TestListsStructs<int>()
                {
                    Arrange = new List<int>() {3, 1, 4, 2}, Expected = new List<int>() {1, 2, 3, 4}
                },
                new TestListsStructs<int>()
                {
                    Arrange = new List<int>() {3, 1, 2}, Expected = new List<int>() {1, 2, 3}
    ...
    {
        public int SearchSorted(List<int> arr, int v)
        {
            return search(arr, v, 0, arr.Count - 1);
        }

        int search(List<int> arr, int v, int l, int r)
        {
            if (l <= r)
            {
                var p = l + (r - l) / 2;
                ...
                if (arr[p] > v)
                {
                    return search(arr, v, l, p - 1);
                }

                if (arr[p] < v)
                {
                    return search(arr, v, p + 1, r);
                }
            }
    ...
    {
        public int Search(List<int> arr, int v)
        {
            return search(arr, v, 0, arr.Count - 1);
        }
        ...
        int search(List<int> arr, int v, int l, int r)
        {
            if (l <= r && v >= arr[l] && v <= arr[r])
            {
                var p = partition(arr, v, l, r);
        ...
        int partition(List<int> arr, int v, int l, int r)
        {
            var res = l + (v - arr[l]) / (r - l) * (arr[r] - arr[l]);
            return res;
        }
    }
}
...
namespace Miscellaneous
{
    public class Miscellaneous
    {
        ...
        public record class RcCl
        {
        }

        public record struct RcSt
        {
        }
        ...
        public class LinkedListReverseCheck
        {
            private static LinkedListReverseCheck i => new LinkedListReverseCheck();
            ...
            private void go()
            {
                ListNode n0 = new ListNode {Value = 0, Next = null};
                ListNode n1 = new ListNode {Value = 1, Next = n0};
                ListNode n2 = new ListNode {Value = 2, Next = n1};
                ListNode n3 = new ListNode {Value = 3, Next = n2};
                ListNode n4 = new ListNode {Value = 4, Next = n3};

                LinkedListReverse l = new();
                l.reset();
                l.Print(n4);
                l.reset();
                l.ReverseLinkedList(n4);
                l.reset();
                l.Print(n0);
            }
        }
        ...
        public class LinkedListReverse : Recursion
        {
            ...
            {
                Trace.WriteLine($"node value:{n.Value}");
                if (n.Next == null)
                {
                    _continue = false;
                    return;
        ...
        public class MergeList
        {
            ...
            public void go()
            {
                ...
                var sorted = left.Union(right).OrderBy(s => s);

                var r = Sort(left, right);

                var b = sorted.SequenceEqual(r);
            }

            public List<int> Sort(List<int> l, List<int> r)
            {
                List<int> result = new List<int>((l.Count + r.Count));
        ...
        public class TNine
        {
            ...
            public class CaseList
            {
                ...
                public void check()
                {
                    if (this.Exp == this.Act) { this.isOK = true; }
        ...
        public class HTTPserializeSave
        {
            ...
            public static async Task<IEnumerable<T>> HttpReqSaveSinglelineSyntax<T>()
            {
                ...
                return JsonSerializer.Deserialize<IEnumerable<T>>(await new HttpClient().GetAsync("")?.Result.Content
                    .ReadAsStringAsync());
            }
        }
        ...
        public class StringCount
        {
            public static void GO(string input)
            {
                ...
                var counts = (
                    ...
                    group s by new {s}
                    into c
                    select new {Key = c.Key, count = c.Count()}).ToList();


                //group by API
                var countsTwo = inp
                    .GroupBy(p => p, (Key, g) => new {K = Key, C = g.Count()}).ToList();
        ...
        public class Convertions
        {
            ...
            public static void GO()
            {
                ...
                try
                {
                    ...
                    //original chars
                    List<char> charsFromByte =
                        new List<char>(bytesFromString.ToList().Where(s => s != 0).Select(Convert.ToChar));
            ...
            public void Bulk()
            {
                ...
                for (int i = 0; i < 65535; i++)
                {
                    try
                    {
                        ...
                        if (!char.IsDigit(chnew) && !char.IsHighSurrogate(chnew) && !char.IsLowSurrogate(chnew) &&
                            !char.IsSurrogate(chnew))
                        {
...
namespace Rewrite
{
    ...
    public class StreamCheck
    {
        ...
        public void ReadFilesCheck()
        {
            ...
            sio3.AddBytesToFile(
                Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(sio3.pathDictList, Formatting.Indented)),
                sio3.pathResult_);
        }
                    ...
                    if (pathDictList.Count != 1)
                    {
                        for (int i = 0; i < pathDictList.Count; i++)
                        {
                            for (int i2 = i; i2 < pathDictList.Count; i2++)
                            {
                                ...
                                {
                                    string newMinimal = CompareMinimal(PathRemoveFileName(pathDictList[i].Path),
                                        PathRemoveFileName(pathDictList[i2].Path));
    ...
    public static class ConsoleParameters
    {
        ...
        public static void Initialize()
        {
            ...
            parameters_.Add(new ParametersForConsole() {ID = 0, ParameterName = @"-m", Description = @"months"});
        }
        ...
        public static void Serialize_()
        {
            ...
            foreach (string filename in Directory.GetFiles(DirectoryIn))
            {
                if (!filename.Contains(@"Thumbs"))
                {
                    ...
                    FileNameOut = Path.GetFileNameWithoutExtension(FilePathIn) + @"_copy" +
                                  Path.GetExtension(FilePathIn);
    ...
    public class TestContext
    {
        ...
        public string VisitBinary(BinaryExpression expression, string op, Expression left, ExpressionType nt,
            Expression right) =>
